...
public class ExternalDisassemblyFieldFactory extends FieldFactory {
	...
	public ListingField getField(ProxyObj<?> proxy, int varWidth) {
		...
		try {
			...
			AttributedString text = new AttributedString(disassembly, FOREGROUND, getMetrics());
	...
	private ListingTextField getErrorText(ProxyObj<?> proxy, int varWidth, Exception e) {
		...
		AttributedString errorText = new AttributedString(message, ALERT_FOREGROUND, getMetrics());
